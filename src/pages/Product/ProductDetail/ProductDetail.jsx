	...
	return (
		<Fragment>
			...
			<input
				name="name"
				type="text"
				className={`form-control mb-3 ${styles.product__title}`}
			...
			<textarea
				name="desc"
				className={`form-control mb-3 ${styles.product__desc}`}
				type="text"
			...
			<input
				name="price"
				type="number"
				className={`form-control mb-3 ${styles.product__price}`}
			...
			<input
				name="capacity"
				type="number"
				className={`form-control mb-3 ${styles.product__capacity}`}
